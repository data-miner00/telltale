...
<template>
  <div
    class="relative flex items-center bg-gray-100 px-2 py-1 rounded"
  ...
  >
    ...
    <div
      v-if="showUserMenu"
      class="border w-48 border-solid bg-white border-gray-200 absolute -bottom-40 -left-10 rounded flex flex-col space-y-1"
    >
      <a href="" class="flex py-3 px-3 items-center gap-3"><Person />Profile</a>
