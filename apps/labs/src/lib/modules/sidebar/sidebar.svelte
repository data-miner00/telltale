...
<aside class="w-72 bg-slate-800 flex h-screen flex-1 flex-col space-y-1 p-2">
  <button
    ...
    <div class="flex flex-col gap-2 text-gray-100 text-sm">
      {#each items as item}
        <button
          ...
          >
          <div class="flex-1 text-left text-ellipsis max-h-5 overflow-hidden break-all relative">
            {item}
            <div
